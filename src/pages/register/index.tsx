...
import { register as registerEndpoint } from 'Services/auth'
import {
  Background,
  Container,
  Title,
      ...
      <Container>
        ...
        <form onSubmit={handleSubmit(onRegister)}>
          ...
          <CheckboxContainer mt={12}>
            <input type='radio' value='innovator' {...register('role', { required: true })} />
            <Label>Inovator</Label>
          </CheckboxContainer>

          <CheckboxContainer mt={12}>
            <input type='radio' value='village' {...register('role', { required: true })} />
