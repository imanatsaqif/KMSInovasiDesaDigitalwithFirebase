    ...
    <Container page>
      ...
      <ContentContainer>
        <div>
          ...
          <ChipContainer>
            <Label onClick={() => navigate(paths.INNOVATION_CATEGORY_PAGE)}>Pertanian Cerdas</Label>
        ...
        <div>
          ...
          <Description>
            Pakan otomatis cerdas yang dapat dikontrol melalui telepon dan dapat disesuaikan dengan kebutuhan pertanian
            setiap petani.
          </Description>
        </div>
        ...
        <div>
          ...
          <Description>
            ...
            Menyimpan data jumlah pakan yang dilempar oleh eFeeder yang dapat diakses melalui aplikasi eFeeder atau
            dashboard.
          </Description>
        </div>
